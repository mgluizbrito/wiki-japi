<header class="d-flex justify-content-center position-fixed w-100 mt-3 z-3">
    <div class="d-flex justify-content-between align-items-center w-50">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class=" btn-entrar ps-5 pe-5">
                <a class="w-100 h-100 d-flex justify-content-center align-items-center" href="{{ route('auth') }}">Entrar</a>
            </div>
        </div>  
    </div>
</header>